...
def is_generate_and_post(message_text: str) -> bool:
    ...
    message_lower = message_text.lower()
    return (
        ("generate" in message_lower and "post" in message_lower) or
        ("create" in message_lower and "post" in message_lower) or
        ("generate" in message_lower and "tweet" in message_lower) or
        ("create" in message_lower and "tweet" in message_lower)
    )
